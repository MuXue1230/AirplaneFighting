...
class Tools:
    ...
    def add_small_enemies(self, group1, group2, num, eventBus, argv, _return=False):
        for i in range(num):
    ...
    def add_mid_enemies(self, group1, group2, num, eventBus, argv, _return=False):
        for i in range(num):
    ...
    def add_big_enemies(self, group1, group2, num, eventBus, argv, _return=False):
        for i in range(num):
